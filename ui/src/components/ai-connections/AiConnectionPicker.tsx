      ...
      {loading ? (
        ...
        <>
          <ConnectionChoiceList
            ...
            onSelect={(id) => {
              if (id === "responsible_user") onChange({provider: requirement.provider, method: personalDefault?.method ?? requirement.method ?? (requirement.provider === "openrouter" || requirement.provider === "ollama" ? "api_key" : "subscription"), mode: "responsible_user"});
